...
class ModelTest extends TestCase
{
    ...
    public function testAddDelete(){
        ...
        try{
            ...
            $this->assertEquals($e->getCode(),MysqlException::MYSQL_PARAM_DATA_ERROR);
        }
    }
    ...
    public function testErrorSql(){
        ...
        try{
            ...
            $this->assertEquals($e->getCode(),MysqlException::MYSQL_SQL_ERROR);
        }
    }
    ...
    public function testExecute(){
        ...
        $userModel = new UserModel();
        $rows = $userModel->execute($sql,DatabaseActionType::SELECT_ALL);
        $this->assertTrue(count($rows)>0);
    }

    public function testUpdateBySql(){
        $id = 1;
        $sql="update user set name='myf' where id=$id";
        $userModel = new UserModel();
        $userModel->updateBySql($sql);

        $user = $userModel->findById($id);
        $this->assertEquals('myf',$user['name']);
