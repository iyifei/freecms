            ...
            <div class="panel-body p-30 ">
                <form autocomplete="off">
                    ...
                    <div class="form-group row m-b-15">
                        <label class="col-form-label col-md-3 text-right"><span class="text-red">*</span>文档标题</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group row m-b-15">
                        <label class="col-form-label col-md-3 text-right"><span class="text-red">*</span>文档文件</label>
                        <div class="col-md-9">
                            <input type="text" readonly="readonly" required="required" class="form-control" id="url" name="url" value="{$data.addOnMedia.url}" />
                            <input class="btn btn-default btn-sm" type="button" id="uploadMediaFile" value="上传文档">
                            <a id="delete_url_attach" href="javascript:deleteMedia()"  class="btn btn-danger btn-sm" {if empty($data.addOnMedia.url)} style="display: none"{/if}>删除文档</a>
                            <br/>
                            <small class="f-s-12 text-grey-darker">支持word(.doc,.docx),excel(.xls,.xlsx),ppt(.ppt,.pptx),pdf等文档相关格式，且大小不能超过20M</small>
                        </div>
                    </div>
                    <div class="form-group row m-b-15">
                        <label class="col-form-label col-md-3 text-right">文档配图</label>
                        <div class="col-md-9">
                            ...
                            <img src="{if !empty($data.litpic)}{$myf_path}/cloud/{$data.litpic}?thumbnail=h-90{/if}" id="imgFile" alt="文档配图预览" title="文档配图预览" style="{if empty($data.litpic)}display:none;{/if}height:50px;margin-right:10px;border:1px solid #ccc;padding:1px;" />
...
<input type="hidden" id="submitUrl" value="{$myf_path}/admin/content/office/save">
