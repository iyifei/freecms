...
<ol class="breadcrumb pull-right">
    ...
    <li class="breadcrumb-item active">音频管理</li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-heading">
                ...
                <h4 class="panel-title">网站音频列表</h4>
            </div>
            <!-- end panel-heading -->
                    ...
                    <div class="col-sm">
                        <div class="dt-buttons btn-group p-b-15">
                            <a class="btn btn-default buttons-html5 btn-sm" tabindex="0"
                               ...
                               href="#!content/audio/edit?method=add"
                            ><span>录入新音频</span></a>
                            <a class="btn btn-default buttons-html5 btn-sm" tabindex="0"
                               aria-controls="data-table-buttons"
                    ...
                    <table id="data-table-buttons"
                        ...
                        {foreach from=$res.rows item=vo}
                            <tr>
                                ...
                                <td><a href="{$myf_path}/admin#!content/audio?typeid={$vo.typeid}"
                                       title="查看该栏目下的音频">{$vo.arctype.typename|escape:'html'}</a></td>
                                <td>
                                ...
                                <td class="">
                                    ...
                                    <a title="编辑" data-toggle="tooltip"
                                       href="{$myf_path}/admin#!content/audio/edit?method=update&id={$vo.id}"
...
<!-- end row -->
<input type="hidden" id="deleteUrl" value="{$myf_path}/admin/content/audio/save">
<input type="hidden" id="saveUrl" value="{$myf_path}/admin/content/audio/save">
<script type="text/javascript">
    $(function () {
        ...
        $("#search-btn").click(function () {
            ...
            var hash = '#!content/audio?typeid='+typeid+"&title="+title;
