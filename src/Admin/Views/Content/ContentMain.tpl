            ...
            <div class="panel-body">
                ...
                <table id="data-table-buttons" class="table table-striped table-bordered">
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td width="1%" class="with-img"><img src="<{$myf_path}>/statics/admin/img/user/user-1.jpg"
                    ...
                    <tr class="even gradeC">
                        ...
                        <td width="1%" class="with-img"><img src="<{$myf_path}>/statics/admin/img/user/user-2.jpg"
                                                             class="img-rounded height-30"/></td>
                        <td>Trident</td>
                    ...
                    <tr class="odd gradeA">
                        ...
                        <td width="1%" class="with-img"><img src="<{$myf_path}>/statics/admin/img/user/user-3.jpg"
                                                             class="img-rounded height-30"/></td>
                        <td>Trident</td>
                    ...
                    <tr class="even gradeA">
                        ...
                        <td width="1%" class="with-img"><img src="<{$myf_path}>/statics/admin/img/user/user-4.jpg"
                                                             class="img-rounded height-30"/></td>
                        <td>Trident</td>
                    ...
                    <tr class="odd gradeA">
                        ...
                        <td width="1%" class="with-img"><img src="<{$myf_path}>/statics/admin/img/user/user-5.jpg"
                                                             class="img-rounded height-30"/></td>
                        <td>Trident</td>
                    ...
                    <tr class="even gradeA">
                        ...
                        <td width="1%" class="with-img"><img src="<{$myf_path}>/statics/admin/img/user/user-6.jpg"
                                                             class="img-rounded height-30"/></td>
                        <td>Trident</td>
                    ...
                    <tr class="gradeA">
                        ...
                        <td width="1%" class="with-img"><img src="<{$myf_path}>/statics/admin/img/user/user-7.jpg"
                                                             class="img-rounded height-30"/></td>
                        <td>Gecko</td>
                        <td>Firefox 1.0</td>
                        <td>Win 98+ / OSX.2+</td>
                    ...
                    <tr class="gradeA">
                        ...
                        <td width="1%" class="with-img"><img src="<{$myf_path}>/statics/admin/img/user/user-8.jpg"
                                                             class="img-rounded height-30"/></td>
                        <td>Gecko</td>
                        <td>Firefox 1.5</td>
                        <td>Win 98+ / OSX.2+</td>
                    ...
                    <tr class="gradeA">
                        ...
                        <td width="1%" class="with-img"><img src="<{$myf_path}>/statics/admin/img/user/user-9.jpg"
                                                             class="img-rounded height-30"/></td>
                        <td>Gecko</td>
                        <td>Firefox 2.0</td>
                        <td>Win 98+ / OSX.2+</td>
                    ...
                    <tr class="gradeA">
                        ...
                        <td width="1%" class="with-img"><img src="<{$myf_path}>/statics/admin/img/user/user-10.jpg"
                                                             class="img-rounded height-30"/></td>
                        <td>Gecko</td>
                        <td>Firefox 3.0</td>
                        <td>Win 2k+ / OSX.3+</td>
                    ...
                    <tr class="gradeA">
                        ...
                        <td width="1%" class="with-img"><img src="<{$myf_path}>/statics/admin/img/user/user-11.jpg"
                                                             class="img-rounded height-30"/></td>
                        <td>Gecko</td>
                        <td>Camino 1.0</td>
                        <td>OSX.2+</td>
                    ...
                    <tr class="gradeA">
                        ...
                        <td width="1%" class="with-img"><img src="<{$myf_path}>/statics/admin/img/user/user-12.jpg"
                                                             class="img-rounded height-30"/></td>
                        <td>Gecko</td>
                        <td>Camino 1.5</td>
                        <td>OSX.3+</td>
                    ...
                    <tr class="gradeA">
                        ...
                        <td width="1%" class="with-img"><img src="<{$myf_path}>/statics/admin/img/user/user-13.jpg"
                                                             class="img-rounded height-30"/></td>
                        <td>Gecko</td>
                        <td>Netscape 7.2</td>
                    ...
                    <tr class="gradeA">
                        ...
                        <td width="1%" class="with-img"><img src="<{$myf_path}>/statics/admin/img/user/user-14.jpg"
                                                             class="img-rounded height-30"/></td>
                        <td>Gecko</td>
