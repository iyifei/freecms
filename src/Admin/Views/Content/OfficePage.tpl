    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-heading">
                ...
                <h4 class="panel-title">网站文档列表</h4>
            </div>
            <!-- end panel-heading -->
                    ...
                    <div class="col-sm">
                        <div class="dt-buttons btn-group p-b-15">
                            <a class="btn btn-default buttons-html5 btn-sm" tabindex="0"
                               ...
                               href="#!content/office/edit?method=add"
                            ><span>录入新文档</span></a>
                            <a class="btn btn-default buttons-html5 btn-sm" tabindex="0"
                               aria-controls="data-table-buttons"
                    ...
                    <table id="data-table-buttons"
                        ...
                        {foreach from=$res.rows item=vo}
                            <tr>
                                ...
                                <td><a href="{$myf_path}/admin#!content/office?typeid={$vo.typeid}"
                                       title="查看该栏目下的文档">{$vo.arctype.typename|escape:'html'}</a></td>
                                <td>
                                ...
                                <td class="">
                                    ...
                                    <a title="编辑" data-toggle="tooltip"
                                       href="{$myf_path}/admin#!content/office/edit?method=update&id={$vo.id}"
...
<!-- end row -->
<input type="hidden" id="deleteUrl" value="{$myf_path}/admin/content/office/save">
<input type="hidden" id="saveUrl" value="{$myf_path}/admin/content/office/save">
<script type="text/javascript">
    $(function () {
        ...
        $("#search-btn").click(function () {
            ...
            var hash = '#!content/video?typeid='+typeid+"&title="+title;
