    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-heading">
                ...
                <h4 class="panel-title">网站视频列表</h4>
            </div>
            <!-- end panel-heading -->
                    ...
                    <div class="col-sm">
                        <div class="dt-buttons btn-group p-b-15">
                            <a class="btn btn-default buttons-html5 btn-sm" tabindex="0"
                               ...
                               href="#!content/video/edit?method=add"
                            ><span>录入新视频</span></a>
                            <a class="btn btn-default buttons-html5 btn-sm" tabindex="0"
                               aria-controls="data-table-buttons"
                    ...
                    <table id="data-table-buttons"
                        ...
                        {foreach from=$res.rows item=vo}
                            <tr>
                                ...
                                <td><a href="{$myf_path}/admin#!content/video?typeid={$vo.typeid}"
                                       title="查看该栏目下的视频">{$vo.arctype.typename|escape:'html'}</a></td>
                                <td>
                                ...
                                <td class="">
                                    ...
                                    <a title="编辑" data-toggle="tooltip"
                                       href="{$myf_path}/admin#!content/video/edit?method=update&id={$vo.id}"
...
<!-- end row -->
<input type="hidden" id="deleteUrl" value="{$myf_path}/admin/content/video/save">
<input type="hidden" id="saveUrl" value="{$myf_path}/admin/content/video/save">
