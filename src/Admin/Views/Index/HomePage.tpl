...
<div class="row">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="widget widget-stats bg-black-lighter">
            ...
            <div class="stats-link">
                <a href="javascript:;">评论管理 <i class="fa fa-arrow-alt-circle-right"></i></a>
            </div>
        </div>
    </div>
    <!-- end col-3 -->
...
<div class="row">
    ...
    <div class="col-lg-6">
        ...
        <div class="panel panel-inverse" data-sortable-id="index-4">
            <div class="panel-heading">
                <h4 class="panel-title">新注册的会员 <span class="pull-right label bg-gradient-teal">24新会员</span></h4>
            </div>
            ...
            <div class="panel-footer text-center">
                <a href="javascript:;" class="text-inverse">所有会员</a>
            </div>
        </div>
        <!-- end panel -->
    </div>
