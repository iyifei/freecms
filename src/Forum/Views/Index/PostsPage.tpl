            ...
            <div class="col-md-9">
                ...
                <ul class="forum-list forum-detail-list">
                    <li>
                        <!-- begin media -->
                        <div class="media">
                            <img src="{$myf_path}/statics/public/img/user/user-1.jpg" alt="" />
...
var handleAddCommasToNumber = function(value) {
    return value.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
                    ...
                    <li>
                        <!-- begin media -->
                        <div class="media">
                            <img src="{$myf_path}/statics/public/img/user/user-2.jpg" alt="" />
                    ...
                    <li>
                        <!-- begin media -->
                        <div class="media">
                            <img src="{$myf_path}/statics/public/img/user/user-3.jpg" alt="" />
                    ...
                    <li>
                        <!-- begin media -->
                        <div class="media">
                            <img src="{$myf_path}/statics/public/img/user/user-4.jpg" alt="" />
                            <span class="label label-inverse">USER</span>
                        </div>
                        <!-- end media -->
                        <!-- begin info-container -->
